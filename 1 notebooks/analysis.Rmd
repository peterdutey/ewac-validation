...
ats$auditc_risklevel <- cut(ats$auditc_score, c(0,1,5,8,13), right = F)
ats <- ats[actage >= 18,]
hse <- hse[hse$dnnow == 1,] # Take only those drinking 'at all these days'
hse$agez <- cut(hse$age, breaks = c(18, 25, 35, 45, 55, 65, 140), right = F)
levels(hse$agez) <- c("18-24", "25-34", "35-44", "45-54", "55-64", "65+")
```
...
The aim of the present study is develop and validate an Estimator of usual Weekly Alcohol Consumption in units (EWAC) based on the Extended AUDIT. We 
This paper reports on a series of empirical studies examining the error of this to
...
Existing research on quantity-frequency alcohol instruments suggests that the product of the quantity and frequency questions in the AUDIT (see AUDIT-1 and AUDIT-2 in [Table 1](#table1)) could be used to produce a measure of usual consumption [@Lemmens1992].
