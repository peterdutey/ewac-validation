...
The last step of this analysis was to examine the EWAC's ability to classify participants' consumption as being equal to or in excess of 14 UK units/week. In comparison with the AUDIT-C score (ranging 0-12), EWAC increased the area under the curve by 5 percentage points (`r table_nums("tab_study1_roc", display = "cite")`), a statistically significant improvement (`r pvrounding(roc.test(roc_auditc, roc_ewac, method = "delong")$p.value)`) on the AUDIT-C. ROC curves are available in Supplementary Material 4. The cut-off that maximises the sum of specificity and sensitivity is 9.95 units/week. In contrast, using the nominal cut-off of 14 units/week yields a sensitivity of `r round(roc_ewac_nominal14$sensitivity, 3)` and a specificity of `r round(roc_ewac_nominal14$specificity, 3)`.

In summary, using an EWAC threshold of 10 units or more over an AUDIT-C score of 5 or more provides equivalent sensitivity, but with a steep gain in specificity of 13 percentage points.
