...
Next, the MD and RMSE are regressed against respondents characteristics in order to identify subgroups with potentially stronger bias or error ([Table 3](#tab_ewac_validity_reg)). Models suggest that the factors account for a negligible proportion of both MD and RMSE (<2%). Despite this: 
- MD is 4.8 units [2.1, 7.5] with in Black respondents and 5.9 units [1.6, 10.2] higher in respondents from Black and Other ethnic groups respectively, while RMSE not significantly different from the  similar. This suggests EWAC has a strong positive bias in Black respondents.
- 
