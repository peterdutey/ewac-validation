...
This paper reports the development of  the EWAC based on the product of quantity (AUDIT-1) by frequency (AUDIT-2) with adjustment for occasional intense drinking (AUDIT-3) using a hierarchical Bayesian item response model calibrated on Extended AUDIT-C and Graduated-Frequency (GF) questionnaire data collected as part of the Alcohol Toolkit Study [@Beard2015a], a large panel survey of community households in England. It then tests the mean deviation and the root mean squared deviation between EWAC and GF in the same sample. Finally, it tests the equivalence of the full Receiver Operating Characteristics Area Under the Curve of EWAC compared with AUDIT-C and the full AUDIT in predicting alcohol consumption in excess 112g/week (14 UK units) and 280g/week (35 UK units) respectively.
...
A longstanding obstacle in alcohol research and treatment is that there is no undisputed 'gold standard' or biomarker for assessing the level and duration of alcohol consumption. Instead, a number of instruments exist which measure self-reported alcohol consumption with varying validity and reliability over different time periods. Comprehensive reviews [@Heeb2005; @Rehm1998] indicate that prospective diaries tend to record higher alcohol consumption by minimising recall bias, followed by GF, while lower levels seem to be recorded with QF measures.
