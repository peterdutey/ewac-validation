...
```{r}
plot(mod1_fit, plotfun = "trace", pars = c('F2', 'F3', 'F4', 'F5', 'F6'))
plot(mod1_fit, plotfun = "trace", pars = c('Q1', 'Q2', 'Q3', 'Q4', 'Q5', 'Q6', 'Q7'))
plot(mod1_fit, plotfun = "trace", pars = c('sigma', 'V1', 'V2', 'V3', 'V4'))
```
